...
export default function Admin() {
  ...
  const { tools, permissionRequests, feedbacks, fetchTools, fetchPermissionRequests, fetchFeedbacks } = useStore();
                      ...
                      <div key={req.id} className="card p-5">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex gap-2">
                            <button className="px-4 py-2 text-sm bg-red-50 text-red-600 hover:bg-red-100 rounded-lg transition-colors">
                              驳回
                            </button>
                    ...
                    feedbacks.map((fb: any) => {
                      ...
                      return (
                        <div key={fb.id} className="card p-5">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-gray-400">提交者：{fb.submitter}</span>
      ...
      {showAddToolModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 animate-fade-in">
          <div className="bg-white rounded-2xl p-6 w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto animate-fade-in-up">
            <h3 className="text-xl font-bold text-gray-800 mb-6">新增工具</h3>

            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">工具名称 *</label>
                <input type="text" placeholder="请输入工具名称" className="input-field" />
              </div>
              ...
              <div>
                ...
                <textarea rows={3} placeholder="简要描述工具用途..." className="input-field resize-none" />
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">负责人</label>
                  <input type="text" placeholder="负责人姓名" className="input-field" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">联系邮箱</label>
                  <input type="email" placeholder="邮箱地址" className="input-field" />
                </div>
              </div>

              <div className="flex items-center gap-2">
                <input type="checkbox" id="requiresPermission" className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" />
              ...
              <div>
                ...
                <textarea rows={2} placeholder="使用注意事项..." className="input-field resize-none" />
              </div>
            </div>
